...
namespace Base.Util.Repository.SqlSugarCore.Implementation
{
    ...
    {
        public IBaseRepository<TEntity> InnerJoin<TEntity2>(Expression<Func<TEntity, TEntity2, bool>> joinExpression)
        {
        ...
        public IBaseRepository<TEntity> InnerJoin<TEntity2, TEntity3>(Expression<Func<TEntity, TEntity2, TEntity3, bool>> joinExpression)
        {
